...
public class WarehouseConverter extends ModelConverter<WarehouseModel, Warehouse> {
    ...
    private WarehouseModel convertToModel(Warehouse entity) {
        ...
        model.setOccupiedVolume(entity.getOccupiedVolume() != null ? entity.getOccupiedVolume() : 0);
        model.setOccupiedWeight(entity.getOccupiedWeight() != null ? entity.getOccupiedWeight() : 0);
        return model;
    }
